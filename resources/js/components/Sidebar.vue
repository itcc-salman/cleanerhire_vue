<template>
    ...
    <aside id="aside" class="ui-aside">
        <ul class="nav" ui-nav>
            ...
            <li>
                <a href="#"><i class="fa fa-users"></i><span>Customers</span><!--<i class="fa fa-angle-right pull-right"></i>--></a>
            ...
            <li>
                <a href="#"><i class="fa fa-tags"></i><span>Price List</span></a>
            </li>
            <li>
                <a href="#"><i class="fa fa-calendar"></i><span>Booking Calendar</span></a>
            </li>
            <li>
                <a href="#"><i class="fa fa-shopping-cart"></i><span>Sales</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="nav nav-sub nav-sub--open">
                    <li ><a href=""><span>Sales Dashboard</span></a></li>
                    <li><a ><span>Enquiries</span></a></li>
                    <li><a><span>Bookings</span></a></li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="fa fa-pie-chart"></i><span>Reports</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="nav nav-sub nav-sub--open">
                    <li ><a href=""><span>Sales Report</span></a></li>
                    <li><a ><span>Bookings Report</span></a></li>
                    <li><a><span>Monthly</span></a></li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="fa fa-cogs"></i><span>Configurations</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="nav nav-sub nav-sub--open">
                    <li ><a href=""><span>Service Lists</span></a></li>
                    <li><a ><span>Customer Registration Form</span></a></li>
                    <li><a ><span>Cleaner Registration Form</span></a></li>
                    <li class="nav-sub-header"><a href=""><span>Cleaning Agency Registration Form</span></a></li>
                    <li><a ><span>Email Templates</span></a></li>
                    <li><a ><span>SMS Integration</span></a></li>
                    <li class="nav-sub-header"><a href=""><span>Payment Integration</span></a></li>
                    <li><a ><span>Setup</span></a></li>
                    <li><a ><span>Admin Users</span></a></li>
                </ul>
            </li>
            <!--<li>
